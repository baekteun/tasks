...
struct HomeView: View {
    ...
    // MARK: - Metched Geometry Namespace
    @Namespace var animation
    
    // MARK: - Fetching Task
    @FetchRequest(entity: Item.entity(), sortDescriptors: [NSSortDescriptor(keyPath: \Item.deadline, ascending: false)], predicate: nil, animation: .easeInOut) var tasks: FetchedResults<Item>
    ...
    @ViewBuilder
    func TaskRowView(task: Item) -> some View {
